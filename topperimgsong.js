 ...
 img3.addEventListener('click', function() {
     ...
     // 설명 보이기/숨기기
     description3.style.opacity = description3.style.opacity === "0" || description2.style.opacity === "" ? "1" : "0";
 });
 // 네 번째 이미지 클릭 이벤트
 ...
 img4.addEventListener('click', function() {
     ...
     // 설명 보이기/숨기기
     description4.style.opacity = description4.style.opacity === "0" || description2.style.opacity === "" ? "1" : "0";
 });
 // 다섯 번째 이미지 클릭 이벤트
 ...
 img5.addEventListener('click', function() {
     ...
     // 설명 보이기/숨기기
     description5.style.opacity = description2.style.opacity === "0" || description2.style.opacity === "" ? "1" : "0";
 });
